...
/* =========================================================
   SUBJECT BOARD STYLES
   ========================================================= */

(function injectScheduleBoardStyles() {

    if (document.getElementById("scheduleBoardStyles")) {
        return;
    }
    ...
    style.textContent = `
        ...
        .schedule-subject-card-header h4 {
            margin: 0;
            font-size: 16px;
            color: #172033;
        }

        .schedule-subject-card-header > div > span {
            display: block;
            margin-top: 4px;
            color: #667085;
            font-size: 12px;
        ...
        .schedule-subject-rows {
            min-height: 74px;
        }

        .schedule-subject-row {
            display: flex;
            justify-content: space-between;
            gap: 16px;
            padding: 13px 20px;
        ...
        .schedule-subject-row-main {
            min-width: 0;
        }

        .schedule-subject-row-main strong {
            display: block;
            font-size: 13px;
            color: #344054;
        }
        ...
        .schedule-type-badge.practical {
            background: #ecfdf3;
            color: #027a48;
        }

        .schedule-type-badge.written {
            background: #eff6ff;
            color: #175cd3;
        }

        .schedule-subject-empty {
            padding: 18px 20px;
            color: #98a2b3;
            font-size: 13px;
        }

        .schedule-subject-card-footer {
            padding: 12px 20px;
            background: #fcfcfd;
        ...
        .schedule-calendar-modal-header h2 {
            margin: 4px 0 5px;
            font-size: 21px;
            color: #172033;
        }

        .schedule-calendar-modal-header p {
            margin: 0;
            color: #667085;
            font-size: 13px;
        }
        ...
        .schedule-calendar-legend .legend {
            width: 9px;
            height: 9px;
            border-radius: 50%;
        ...
        #scheduleCalendarModal .month-card {
            margin: 0;
        }
