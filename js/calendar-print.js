...
(function bootCalendarPrint() {
    ...
    function buildMonth(month, calendarYear, schedules) {
        ...
        heads.forEach((h, i) => cells.push(`<div class="print-week ${i >= 5 ? "print-weekend-head" : ""}">${h}</div>`));
        ...
        for (let d = 1; d <= days; d++) {
            ...
            cells.push(`<div class="print-day ${weekend ? "print-weekend" : ""} ${scheduled ? "print-scheduled" : ""}"><span>${d}</span></div>`);
        }
    ...
    function buildPrintDocument() {
        ...
        wrapper.innerHTML = `
            <div class="print-page print-page-calendar">
                ...
                <div class="print-legend"><span><i class="written"></i> Tes Tertulis</span><span><i class="practical"></i> Tes Praktik</span><span><i class="weekend"></i> Hari Libur (Sabtu/Minggu)</span></div>
